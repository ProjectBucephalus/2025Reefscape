...
public class MechanismConstants 
{
  ...
  {    
    ...
    public static final double diffectorCruiseMotor = 55;// 90;
    /** Desired cruise speed of Motor when holding Algae, RPS */
    public static final double diffectorAlgaeCruiseMotor = 0.65 * diffectorCruiseMotor;
    /** Desired acceleration of Motor for Elevation, RPS^2 */
    public static final double diffectorElevationAccelerationMotor = 75;// 150;
    /** Desired acceleration of Motor for Rotation, RPS^2 */
    public static final double diffectorRotationAccelerationMotor = 40;// 80;
    /** Desired acceleration of Motor for Rotation when holding Algae, RPS^2 */
    public static final double diffectorAlgaeRotationAccelerationMotor = 0.65 * diffectorRotationAccelerationMotor;
