...
public class CustomADStar implements Pathfinder 
{
  ...
  public CustomADStar(String navGridFilePath) 
  {
    ...
    File navGridFile = new File(Filesystem.getDeployDirectory(), navGridFilePath);
    ...
    planningThread.setName("ADStar Planning Thread " + navGridFilePath);
  ...
  private List<GridPosition> extractPath (GridPosition sStart, GridPosition sGoal, Set<GridPosition> obstacles) 
  {
    ...
    for (int k = 0; k < 200; k++) // TODO: May need to expand this limit for Diffector pathfinding
    {
